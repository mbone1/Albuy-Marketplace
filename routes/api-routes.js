...
module.exports = function(app) {
        ...
        //Route for calling out to spotify API. Takes in the album searched by the user from the front end
        app.get("/api/album_data/:albumSearch", async function(req, res) {
            ...
            //sends the response back to the front end
            res.json(albumResponse);
        });

    }
    //     app.post("api/album_data", async function(req, res) {
    //             db.insertOne([
    //                 "artist", "releasedate:", "albumName", "albumCoverM", "url", "price"
    //             ], [
    //                 req.body.artist, req.body.releasedate,
    //                 req.body.albumName, req.body.albumCoverM,
    //                 req.body.url, req.body.price
    //             ], function(result) {
    //                 res.json("Your album has been put up for sale!")
    //             })
    //         }
